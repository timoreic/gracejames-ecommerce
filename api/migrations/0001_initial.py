    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surcharge', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baseprice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('surcharge', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('totalprice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basePrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('sizeSurcharge', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('materialSurcharge', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
